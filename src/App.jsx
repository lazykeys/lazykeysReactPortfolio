export default function App() {
  return (
    <div className="flex flex-col m-8 h-full w-auto">
      <Header></Header>
      <Subheader></Subheader>
      <About></About>
      <Links></Links>
