export default function App() {
  return (
    <div className="flex flex-col m-8 min-h-full w-auto">
      <Header></Header>
      <Subheader></Subheader>
      <About></About>
      <Links></Links>
...
function Header() {
  return (
    <header className="flex flex-col justify-between items-baseline h-60 w-max">
      <h1 className="text-lk-6 font-DigitalDiscoRegular text-4xl">
        Hello! I'm
      </h1>
      <img className="w-96 h-32" 
...
function About() {
  return (
    <p className="text-lk-6 font-DigitalDiscoThin text-2xl max-w-96">
